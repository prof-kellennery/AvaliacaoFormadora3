...
function Cancelar(){
    ...
    var baseUrl = window.location.origin + '/AvaliacaoFormadora/Autor'; // Base URL
...
function Salvar(){
    ...
    var href = window.location.origin + '/AvaliacaoFormadora/Autor/' + metodo;
...
function Visualizar(id){
    LimparCampos();
    var parametro = id;  
    var href = window.location.origin + '/AvaliacaoFormadora/Autor/visualizar/' + parametro;
    history.replaceState(null, null, href); 
...
function Excluir(id){
    var parametro = id;  
    var href = window.location.origin + '/AvaliacaoFormadora/Autor/excluir/' + parametro;
    history.replaceState(null, null, href); 
    ...
    var baseUrl = window.location.origin + '/AvaliacaoFormadora/Autor'; 
    history.replaceState(null, null, baseUrl); 
}
...
function Pesquisar(){
    ...
    var href = window.location.origin + '/AvaliacaoFormadora/Autor/pesquisar/' + parametro;
