...
function Cancelar(){
    ...
    var baseUrl = window.location.origin + '/AvaliacaoFormadora/Editora'; 
...
function Salvar(){
    ...
    var href = window.location.origin + '/AvaliacaoFormadora/Editora/' + metodo;
...
function Visualizar(id){
    LimparCampos();
    var parametro = id;  
    var href = window.location.origin + '/AvaliacaoFormadora/Editora/visualizar/' + parametro;
    history.replaceState(null, null, href); 
...
function Excluir(id){
    var parametro = id;  
    var href = window.location.origin + '/AvaliacaoFormadora/Editora/excluir/' + parametro;
    history.replaceState(null, null, href); 
...
function Pesquisar(){
    ...
    var href = window.location.origin + '/AvaliacaoFormadora/Editora/pesquisar/' + parametro;
